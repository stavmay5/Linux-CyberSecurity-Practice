...
# Linux Cybersecurity Practice

This repository contains a series of exercises and practical tasks related to Linux and cybersecurity. The exercises cover basic commands, user and group management, permissions, network configuration, and remote control services.

## Table of Contents

- [Part 1: Basic Commands](#part-1-basic-commands)
- [Part 2: Search Commands](#part-2-search-commands)
- [Part 3: User & Group Management](#part-3-user--group-management)
- [Part 4: Permissions](#part-4-permissions)
- [Part 5: ifconfig and Address settings](#part-5-ifconfig-and-address-settings)
- [Part 6: Remote control and telnet services](#part-6-remote-control-and-telnet-services)
- [Part 7: SSH connection](#part-7-ssh-connection)
- [Part 8: vsftpd](#part-8-vsftpd)
- [Part 9: Questions](#part-9-questions)
...
1. לבדוק בכל מכונה מהי כתובת הip בעזרת הפקודה ifconfig (LINUX) ipconfig (WINDOW)
2. יש לכתוב בכל אחת מהמכונות ping ומיד לאחר מכן את כתובת הip של המכונה איתה נרצה לבדוק חיבור, כלומר המכונה השניה
3. יש לבדוק כי ישנה שליחת פקטות ממכונה למכונה, מה שאומר כי יש חיבור בין המכונות
...
This document provides a comprehensive overview of basic Linux commands and cybersecurity concepts. The exercises are designed to provide hands-on experience with the Linux command line and to introduce fundamental security principles.
...
Stav - [stav0526@gmail.com](mailto:stav0526@gmail.com)

Project Link: [https://github.com/stav0526/Linux-CyberSecurity-Practice](https://github.com/stav0526/Linux-CyberSecurity-Practice)
